// .v file generated by riscv-mini project; converted to sv for assertions
// sby finished BMC for 50 cycles in ~1s (probably faster parse)
module ALUSimple(
  input         clock,
  input         reset,
  input  [31:0] io_A,
  ...
  `ifdef FORMAL
  always @* assume(io_alu_op == 4'd10 || io_alu_op == 4'd11);
  // discount implication operator
  always @* assert(!(io_alu_op == 4'd10) || (io_out == io_A));
  always @* assert(!(io_alu_op == 4'd11) || (io_out == io_B));
  `endif
endmodule
